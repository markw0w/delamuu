...
function SaucesManager() {
  ...
  const API_URL_GET_SAUCES = "https://delamuu.com/sauces/get-sauces";
  const API_URL_ADD_SAUCES = "https://delamuu.com/sauces/add-sauce";
  const API_URL_DEL_SAUCES = "https://delamuu.com/sauces/delete-sauce";
